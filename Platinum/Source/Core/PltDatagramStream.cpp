...
{
//	printf("info.local_address : %s \n",info.local_address.GetIpAddress().ToString().GetChars());
//	printf("info.remote_address : %s \n",info.remote_address.GetIpAddress().ToString().GetChars());
    info = m_Info;
    return NPT_SUCCESS;
}
